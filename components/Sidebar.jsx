        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          ...
          <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 pb-4">
            <div className="flex h-16 gap-3 shrink-0 items-center">
               <img src='../images/meddy-onlylogo.svg' className='w-8 h-8'/>
               <h2 className='text-md text-indigo-700 font-bold'>Meddy</h2>
            </div>
              ...
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                <li>
                  <ul role="list" className="-mx-2 space-y-1">
                    {navigation.map((item) => (
                      <li key={`http://localhost:3000//${item.name}`}>
                        <Link href={item.id}>
                        <p
                        ...
                        >
                          <item.icon
                            className={classNames(
                             pathname.path === `/${item.id}` ? 'text-indigo-600' : 'text-gray-400 group-hover:text-indigo-600',
                              'h-6 w-6 shrink-0'
                            )}
                            aria-hidden="true"
                          />
