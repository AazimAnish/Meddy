...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 w-full clearNav z-50">
      <div style={{ maxWidth: "100rem" }} className=" mx-auto flex flex-wrap p-5 flex-col md:flex-row">
        ...
        >
          <div className="md:ml-auto md:mr-auto font-4 pt-1 md:pl-14 pl-1 flex flex-wrap items-center md:text-base text-1xl md:justify-center justify-items-start">
            <a className=" pr-2 cursor-pointer text-slate-600 hover:text-black font-semibold tr04">
              Features
            </a>
            <a className="mx-10 md:ml-11 ml-0 cursor-pointer text-slate-600 hover:text-white font-semibold tr04">
              Pricing
            </a>
            <a className=" cursor-pointer text-slate-600 hover:text-white font-semibold tr04">
              Careers
            </a>
          </div>
          <a
            data-v-54e46119=""
            href="https://github.com/AazimAnish/Meddy"
